describe('Scenarios2023 Script', () => {

    it('Scenario 1 2023- Suzie MFJ', () => {
    ...
    it('Scenario 2 2023 - Cindy MFJ', () => {
        cy.get('@contentJSON').then((content) => {
            ...
            cy.get('[data-testid="nextButton"]').click()
            cy.get('[data-testid="resultsIntro-p1"]').contains('$1,933')
        })
    })
    it('Scenario 3 2023 - Tom MFS', () => {
        cy.get('@contentJSON').then((content) => {
            cy.get('[data-testid="year-2023"]').click()
            cy.get('[data-testid="citizen-yes"]').click()
            cy.get('[data-testid="validSSN-yes"]').click()
            ...
            cy.get('[data-testid="nextButton"]').click()
            cy.get('[data-testid="resultsIntro-p1"]').contains('$4,595')
        })
    })
    it('Scenario 4 2023 - Bonnie Single', () => {
        cy.get('@contentJSON').then((content) => {
            cy.get('[data-testid="year-2023"]').click()
            cy.get('[data-testid="citizen-yes"]').click()
            cy.get('[data-testid="validSSN-yes"]').click()
    ...
    it('Scenario 5 2023- Steve Single', () => {
        cy.get('@contentJSON').then((content) => {
            cy.get('[data-testid="year-2023"]').click()
            cy.get('[data-testid="citizen-yes"]').click()
            cy.get('[data-testid="validSSN-yes"]').click()
            ...
            cy.get('[data-testid="nextButton"]').click()
            cy.get('[data-testid="resultsIntro-p1"]').contains('$1,726')
        })
    })
    it('Scenario 6 2023- Jen HOH', () => {
        cy.get('@contentJSON').then((content) => {
            cy.get('[data-testid="year-2023"]').click()
            cy.get('[data-testid="citizen-yes"]').click()
            cy.get('[data-testid="validSSN-yes"]').click()
            ...
            cy.get('[data-testid="resultsIntro-p1"]').contains('$7,430')
        })
    })
    it('Scenario 7 2023 - Mike HOH', () => {
        cy.get('@contentJSON').then((content) => {
            cy.get('[data-testid="year-2023"]').click()
            cy.get('[data-testid="citizen-yes"]').click()
            cy.get('[data-testid="validSSN-yes"]').click()
            ...
            cy.get('[data-testid="resultsIntro-p1"]').contains('$1,524')
        })
    })
    it('Scenario 8 2023 - Fred MFJ', () => {
        cy.get('@contentJSON').then((content) => {
            cy.get('[data-testid="year-2023"]').click()
            cy.get('[data-testid="citizen-yes"]').click()
            cy.get('[data-testid="validSSN-yes"]').click()
    ...
    it('Scenario 9 2023- Joe QW', () => {
        cy.get('@contentJSON').then((content) => {
            ...
            cy.get('[data-testid="resultsIntro-p1"]').contains('$1,330')
        })
    })
    it('Scenario 10 2023- 65 and older', () => {
        cy.get('@contentJSON').then((content) => {
            cy.get('[data-testid="year-2023"]').click()
            cy.get('[data-testid="citizen-yes"]').click()
            cy.get('[data-testid="validSSN-yes"]').click()
            ...
            cy.get('[data-testid="children.4.relationship-qualifyingRelationship1"]').click()
            cy.get('[data-testid="children.4.age-age-19-23"]').click()
            cy.get('[data-testid="children.4.younger-input-no"]').click()
            cy.get('[data-testid="nextButton"]').click()

            cy.get('[data-testid="resultsIntro-p1"]').contains('$504')
        })
    })
})