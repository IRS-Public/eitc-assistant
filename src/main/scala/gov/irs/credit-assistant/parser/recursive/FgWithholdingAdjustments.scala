...
case class FgWithholdingAdjustments(
    legacyFgWithholdingAdjustments: gov.irs.creditassistant.parser.FgWithholdingAdjustments,
) extends FlowNode {
...
object FgWithholdingAdjustments extends FlowNodeParser {
  override def fromXml(
    ...
    val legacyFgWithholdingAdjustments =
      gov.irs.creditassistant.parser.FgWithholdingAdjustments
        .parse(fgWithholdingAdjustmentsElement, flowParser.factDictionary)
